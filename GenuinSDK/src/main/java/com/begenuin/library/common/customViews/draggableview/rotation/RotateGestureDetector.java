package com.begenuin.library.common.customViews.draggableview.rotation;
...
public class RotateGestureDetector extends TwoFingerGestureDetector {
	...
	public interface OnRotateGestureListener {
		public boolean onRotate(RotateGestureDetector detector,float dx,float dy);
        ...
        switch (actionCode) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mCurrPressure / mPrevPressure > BaseGestureDetector.PRESSURE_THRESHOLD) {
                    final boolean updatePrevious = mListener.onRotate(this,event.getRawX(),event.getRawY());
                    if (updatePrevious) {
                        mPrevEvent.recycle();
                        mPrevEvent = MotionEvent.obtain(event);
                    }
