...
class StepProgressView @JvmOverloads constructor(
    ...
    public var rectRadius: Float by OnValidateProp(0F.pxValue())


    public var textMargin: Float by OnValidateProp(10F.pxValue())


    public var progressBarHeight: Float by OnLayoutProp(5F.pxValue())
...
//        rectRoundPath.addArc(arcRect, 90F, 180F)
        ...
        rectRoundPath.addRect(leftP, topP, rightP, bottomP, Path.Direction.CW)
